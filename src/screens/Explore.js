    ...
    <div>
      ...
      <div style={{ padding:10, display:'flex', gap:10 }}>
        <input
          ...
          placeholder="Caută..."
          style={{ flex:1, padding:8, borderRadius:5, background:'#34495E', color:'#fff', border:'none' }}
        />
        <button
          onClick={handleSearch}
          style={{ background:'#FFB162', border:'none', padding:'8px 12px', borderRadius:5 }}
        >
          Search
        </button>
      </div>
      ...
      <div style={{ padding:10 }}>
        {/* Folosim PUBLIC_URL pentru GitHub Pages */}
        <iframe
